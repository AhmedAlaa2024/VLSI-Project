...
set parameters 0
set param_values { {N 32} }
set top_module "registered_WTM"
set output_dir "${ekit_dir}/${top_module}"

###########################TODO RTL and Constraints paths ######################
set rtl_list { "HA.v" "FA.v" "WTM8.v" "adder64.v" "WTM32.v" "register.v" "registered_WTM.v" "registered_WTM_tb.v" }
set demo_WTM_sdc_files "${ekit_dir}/constraints/demo_WTM_func.sdc"
################################# RTL and Libraries ###########################################
...
set power_files "${ekit_dir}/constraints/demo_WTM.85.upf"
